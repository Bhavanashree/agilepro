...
public class StoryTaskEntity extends WebutilsExtendableEntity
{
	...
	@ManyToOne
	@PropertyMapping(type = StoryTaskModel.class, from = "projectId", subproperty = "id")
	...
	@ManyToOne
	@PropertyMapping(type = StoryTaskModel.class, from = "storyId", subproperty = "id")
